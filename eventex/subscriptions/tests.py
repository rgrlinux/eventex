...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Rogerio Oliveira', email.body)
        self.assertIn('31095929836', email.body)
        self.assertIn('rgrlinux@gmail.com', email.body)
        self.assertIn('11-98088-7373', email.body)
